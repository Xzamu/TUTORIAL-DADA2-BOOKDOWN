...
library(tippy)
```
Phyloseq `r tippy::tippy("¿Qué hace?", "Crea un objeto phyloseq que integra la tabla de OTU, los datos de las muestras, la información taxonómica y el árbol filogenético.")`.
